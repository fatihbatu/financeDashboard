  ...
  return (
    <>
      <DashboardBox gridArea='g'>
        <BoxHeader title='List of Product' sideText={`${productData?.length} products`} />
        <Box
          mt='0.5rem'
          p='0 0.5rem'
          height='75%'
      ...
      <DashboardBox gridArea='j'>
        ...
        <Typography variant='h6' margin='0 1rem'>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique neque alias odio
          exercitationem, repudiandae quidem quae voluptates est reiciendis veritatis, perspiciatis
          porro ipsum cum totam consequuntur nobis. Dolores, nobis quis!
        </Typography>
      </DashboardBox>
    </>
  )
